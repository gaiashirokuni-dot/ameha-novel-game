  ...
  nayuta: {
    ...
    date: {
      ...
      route: {
        ...
        replies: {
          a: "「いいね。歌うのも聴くのも好き。\n○○ちゃんの好きな曲、教えて。」",
          b: "「じゃあゆっくり歩こっか。\n気になった景色、いっぱい残そう。」",
          c: "「僕に任せる？\nじゃあ今日は、行き先を決めすぎない日にしよ。」"
        },
        closing: "少しずつ会話がほどけて、気づけば最初の緊張はなくなっていた。"
      },
    ...
    love: {
      ...
      route: {
        ...
        closing: "夜の街を歩くうち、二人の距離はさっきより少しだけ近くなっていた。"
      },
    ...
    adult: {
      ...
      route: {
        ...
        closing: "静かな声に背中を押されるように、二人は部屋の奥へ進んでいく。"
      },
